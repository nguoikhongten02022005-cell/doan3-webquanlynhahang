...
export const CAC_TAB_NOI_BO = Object.freeze([
  ...
  { key: TAB_NOI_BO.MON_AN, label: 'Quản lý món ăn', chiChoQuanLy: true },
  { key: TAB_NOI_BO.TAI_KHOAN, label: 'Tài khoản', chiChoQuanLy: true },
])
...
export const TRANG_THAI_DON_SAP_TOI = new Set(['PENDING', 'YEU_CAU_DAT_BAN', 'GIU_CHO_TAM', 'DA_XAC_NHAN', 'CAN_GOI_LAI', 'CHO_XAC_NHAN', 'DA_GHI_NHAN', 'DA_CHECK_IN', 'DA_XEP_BAN'])
