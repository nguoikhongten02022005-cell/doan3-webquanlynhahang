  ...
  return (
    <section className="xac-thuc-page xac-thuc-page-editorial xac-thuc-page-register">
      <div className="xac-thuc-card">
        ...
        {!backendMode ? <Alert type="warning" showIcon title="Ứng dụng chưa kết nối máy chủ. Vui lòng kiểm tra cấu hình hệ thống trước khi đăng ký." style={{ marginBottom: 16 }} /> : null}
