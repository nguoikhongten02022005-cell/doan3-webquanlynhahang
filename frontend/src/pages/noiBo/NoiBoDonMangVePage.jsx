...
import { capNhatTrangThaiDonMangVeApi, layDanhSachDonMangVeChoNoiBoApi } from '../../services/api/apiMangVe'
...
function NoiBoDonMangVePage() {
  ...
  const taiLai = async () => {
    setDangTai(true)
    try {
      const { duLieu } = await layDanhSachDonMangVeChoNoiBoApi()
...
export default NoiBoDonMangVePage
