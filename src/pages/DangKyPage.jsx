...
function DangKyPage() {
  ...
  return (
    <section className="auth-page auth-page-editorial auth-page-register">
      <div className="auth-shell">
        <div className="auth-aside">
          <p className="auth-kicker">Tạo tài khoản cho trải nghiệm tại bàn</p>
          <h1 className="auth-title">Đăng ký để đặt bàn, theo dõi đơn và giữ mọi trải nghiệm trong một nơi.</h1>
        ...
        <div className="auth-card">
          <p className="auth-card-kicker">Tạo tài khoản mới</p>
          <h2 className="auth-card-title">Đăng ký</h2>
          <p className="auth-card-subtitle">Tạo tài khoản mới để đặt bàn và theo dõi đơn nhanh hơn.</p>
