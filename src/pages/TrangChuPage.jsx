...
import { getHomeSignatureDishes } from '../services/mappers/anhXaThucDon'
...
function TrangChuPage() {
  ...
  const dacTrungDishes = useMemo(() => getHomeSignatureDishes(dishes), [dishes])
        ...
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions-group">
              <Link className="btn btn-primary" to="/dat-ban">
                Đặt bàn ngay
              </Link>
              <Link className="btn btn-ghost" to="/thuc-don">
                Xem thực đơn
              </Link>
            </div>
          ...
          <div className="hero-showcase">
            <article className="hero-card">
              <div className="hero-card-head">
                <span className="hero-tag">Khung ảnh nổi bật</span>
              ...
              <div className="hero-art">
                <div className="hero-visual-frame">
                  <div className="hero-visual-copy">
                    <span className="hero-visual-kicker">Khung ảnh đặc trưng</span>
        ...
        <div className="container">
          ...
          <div className="category-row">
            {HOME_CAC_DANH_MUC_THUC_DON.map((category, index) => (
              <Link key={category.name} to="/thuc-don" className="category-item">
      ...
      <section className="dac-trung-section">
        <div className="container">
          ...
          <div className="food-grid">
            {dacTrungDishes.map((dish) => (
              <TheMonAn key={dish.id} dish={dish} onAddToCart={handleAddToCart} onOpenDetail={openDetailModal} variant="menu" />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="booking-banner" id="booking">
        <div className="container booking-inner">
          ...
          <div className="booking-cta">
            <Link className="btn btn-light" to="/dat-ban">
              Giữ bàn cho tối nay
            </Link>
