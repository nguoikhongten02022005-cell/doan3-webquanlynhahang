...
function DatBanThanhCong({ bookingCode, bookingStatus, formData, guestCount, successHeading, successStatusLabel, onGoHome, onGoProfile }) {
  return (
    <div className="booking-success booking-success-premium">
      ...
      <div className="booking-success-grid">
        <div className="booking-success-item"><span>Ngày dùng bữa</span><strong>{dinhDangNgayHienThi(formData.date)}</strong></div>
        ...
        <div className="booking-success-item"><span>Khu vực</span><strong>{layVanBanTomTatChoNgoi(formData.seatingArea)}</strong></div>
