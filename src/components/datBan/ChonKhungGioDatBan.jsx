import { BOOKING_SLOT_LEGEND } from '../../constants/giaoDienDatBan'
  ...
  return (
    <div className="booking-availability-panel" ref={availabilityPanelRef}>
      ...
      {!formData.guests ? (
        ...
        <div className="timeslot-empty booking-placeholder-large"><span className="placeholder-icon">⚠️</span><span>{GOI_Y_NGAY_KHONG_HOP_LE}</span></div>
      ) : guestCount > SO_KHACH_TOI_DA_DAT_BAN_TRUC_TUYEN ? (
        <div className="timeslot-empty booking-placeholder-large"><span className="placeholder-icon">📞</span><span>{THONG_DIEP_HOTLINE_NHOM_DONG}</span></div>
      ) : (
        <>
