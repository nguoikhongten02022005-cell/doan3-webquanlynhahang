...
import { BOOKING_CALENDAR_WEEKDAYS } from '../../constants/giaoDienDatBan'
    ...
    <section className={`booking-editorial-card ${isLocked ? 'booking-section-locked' : ''}`} ref={calendarContainerRef}>
      ...
      <div className="booking-form-grid-split">
        <div className="form-field">
          ...
          <span className="booking-field-note">Không nhận đặt bàn vào {VAN_BAN_THU_DONG_CUA}. Ngày nghỉ được khóa trực tiếp trong lịch.</span>
