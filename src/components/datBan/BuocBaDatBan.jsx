...
function BuocBaDatBan({ formData, guestCount, selectedSeatOperationalNote }) {
      ...
      <section className="booking-review-grid">
        <article className="booking-editorial-card booking-review-card-main">
          ...
          <div className="booking-review-list">
            ...
            <div className="booking-review-item booking-review-item-primary"><span>Ngày dùng bữa</span><strong>{dinhDangNgayHienThi(formData.date)}</strong></div>
            ...
            <div className="booking-review-item booking-review-item-primary"><span>Dự kiến sử dụng bàn</span><strong>{layThoiLuongBuaAnText(guestCount, formData.time)}</strong></div>
            <div className="booking-review-item booking-review-item-primary"><span>Khu vực ưu tiên</span><strong>{layVanBanTomTatChoNgoi(formData.seatingArea)}</strong></div>
            <div className="booking-review-item booking-review-item-primary"><span>Trạng thái sau khi gửi</span><strong>{NHAN_TRANG_THAI_DAT_BAN[submissionStatus]}</strong></div>
        ...
        <aside className="booking-editorial-card booking-policy-card-premium">
          ...
          <div className="booking-policy-notes booking-policy-notes-premium">
            {layDanhSachChinhSach(guestCount, formData.seatingArea, formData.time).map((item) => (
